public class Constants {
    ...
    public static final String RULES_TEXT = "In this game, the objective of both players is to capture the enemy's king \n"
            ...
            + "A pawn (P/δ) can move one square forward at a time, if it's the pawn's first turn, it can also move 2 squares forward. It can only capture pieces one square diagonally forward. \n"
